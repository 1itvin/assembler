...
initValues:
	...
	startLoopInitVal:
		...
		mov		EDX, dword ptr [ EBP + 12 ]         ; EDX = offset values[i]
	 	...
	 	fadd	qword ptr [ EAX ]                   ; ST(0) = ST(0) + b
	 	jmp		continue                       	
	 	
	 	lbl:										; if ( argumets[i] > 0 )
	 	mov		EAX, dword ptr [ EBP + 20 ]         ; EAX = offset a
	    fld		qword ptr [ EAX ]                   ; ST(0) -> ST(1), ST(0) = a
	    fyl2x                                   	; ST(0) = log2( ST(0) ) * ST(1)
	    fld		ST(0)                           	; ST(0) -> ST(1), ST(0) = ST(1)
	    frndint                                 	; ST(0) = trunc( ST(0) )
	    fxch 	ST(1)                           	; ST(0) <-> ST(1)
	    fsub	ST(0), ST(1)                    	; ST(0) = ST(0) - ST(1)
	    f2xm1                                   	; ST(0) = 2^( ST(0) ) - 1 ( -1 <= ST(0) <= 1 )
	    fld1                                    	; ST(1) -> ST(2), ST(0) -> ST(1), ST(0) = 1
	    faddp	ST(1), ST(0)                    	; ST(1) = ST(1) + ST(0), ST(1) -> ST(0), ST(2) -> ST(1)
	    fscale                                  	; ST(0) = ST(0) * 2 ^ ( ST(1) )
	    fld1                                    	; ST(0) -> ST(1), ST(0) = 1
	    faddp	ST(1), ST(0)                    	; ST(1) = ST(1) + ST(0), ST(1) -> ST(0)
	    mov		EAX, dword ptr [ EBP + 24 ]        	; EAX = offset b
	    fld		qword ptr [ EAX ]                   ; ST(0) -> ST(1), ST(0) = b
	    fsub	ST(0), ST(1)                    	; ST(0) = ST(0) - ST(1)
