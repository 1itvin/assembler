...
initValues:
	...
	push	3										; reserve memory and initialize local variable								
	...
	startLoopInitVal:
		...
		mov		EDX, dword ptr [ EBP + 12 ]         ; EDX = offset values[i]
	 	...
	 	finit                                   	; clear ST
	 	fld1                                        ; ST(0) = 1
	 	fld  	qword ptr [ EBX ]     				; ST(0) = arguments[i]
	 	...
	 	fld1                                    	; ST(0) -> ST(1), ST(0) = 1
	 	fild		dword ptr [ EBP - 4 ]           ; ST(1) -> ST(2), ST(0) -> ST(1), ST(0) = 3
	 	fyl2x                                   	; ST(0) = ST(1) * log2( ST(0) ), ST(2) -> ST(1)
	 	fdivr	ST(0), ST(1)                    	; ST(0) = ST(0) / ST(1) 
