...
initValues:
	...
	startLoopInitVal:
        ...
        fldl2e                                  	; ST(0) -> ST(1), ST(0) = log2(e)
        fld		ST(0)                           	; ST(1) -> ST(2), ST(0) -> ST(1), ST(0) = ST(0)
        frndint                                 	; ST(0) = trunc( ST(0) )
        fxch	ST(1)                           	; ST(0) <-> ST(1)
        fsub 	ST(0), ST(1)                   		; ST(0) = ST(0) - ST(1)
        f2xm1                                   	; ST(0) = 2^( ST(0) ) - 1 ( -1 <= ST(0) <= 1 )
        fld1                                    	; ST(2) -> ST(3), ST(1) -> ST(2), ST(0) -> ST(1), ST(0) = 1
        faddp	ST(1), ST(0)                    	; ST(1) = ST(0) + ST(1), ST(1) -> ST(0), ST(2) -> ST(1), ST(3) -> ST(2)
        ...
        mov		EAX, dword ptr [ EBP + 24 ]         ; EAX = offset b
        fsub	qword ptr [ EAX ]                  	; ST(0) = ST(0) - b
