...
bubbleSort:
    ...
    startLoopSort1:
    	...
    	startLoopSort2:
    		...
    		mov		EAX, 20							; EAX = 20
    		mul		ECX                             ; EAX = 20 * ECX ( element offset )
    		
    		add		EBX, EAX						; EBX = EBX + EAX ( array[ ECX ] )
    		push	EBX						
    		add		EBX, 20							; EBX = EBX + EAX + 20 ( array[ ECX + 1 ] )
    		push	EBX
    		...
    		push	EBX
    		add		EBX, 20							; EBX = EBX + EAX + 20 ( array[ ECX + 1 ] )
    		push	EBX                             ; swap(array[ ECX + 1 ], array[ ECX ])
    		call	swap 
...
;---------------------------------------------------------------------------------------------------
	...
	push	n
	push	offset array
	call	bubbleSort								; bubbleSort(array, n, listCompareByWeight)
...
;---------------------------------------------------------------------------------------------------
	...
	push	n
	push	offset array
	call	bubbleSort						   		; bubbleSort(array, n, listCompareByDate)
